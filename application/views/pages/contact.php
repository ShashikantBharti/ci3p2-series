    ...
    <div class="row">
        ...
        <div class="col-md-8">
            <div class="card my-4 shadow">
                ...
                echo form_input(array('id'=>'name', 'name'=>'name', 'class'=>"form-control $validName", 'placeholder'=>'Your Name...'));
                ...
                echo form_input(array('id'=>'email', 'type'=>'email', 'name'=>'email', 'class'=>"form-control $validEmail", 'placeholder'=>'Your Email ID...'));
                ...
                echo form_input(array('id'=>'mobile', 'name'=>'mobile', 'class'=>"form-control $validMobile", 'placeholder'=>'Your Mobile Number...'));
                ...
                echo form_textarea(array('id'=>'message', 'name'=>'message', 'class'=>"form-control $validMessage", 'rows'=>5,'placeholder'=>'Your message...'));
